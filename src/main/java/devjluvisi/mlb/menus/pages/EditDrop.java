...
public class EditDrop extends BasePage {
    ...
    public EditDrop(LuckyMenu menu) {
        super(menu);
        this.setMenuName("Editing Drop #" + this.getDropIndex());
    ...
    public void onClick(MenuView view, ClickType clickType, int slot, ItemStack itemStack) {
        ...
        if (itemStack.equals(this.getSpecialItem(SpecialItem.SAVE_BUTTON))) {
            view.getPlayer().performCommand("mlb config save");
            return;
        }
        ...
        if (itemStack.equals(this.getSpecialItem(SpecialItem.ADD_STRUCTURE))) {
            view.getPlayer().performCommand("mlb struct");
            view.close();
            return;
        }
