...
public class ChangeRarity extends BasePage {
	...
	public ItemStack[] getContent() {
		...
		content[1][4] = getPlaceholderItem(Material.EXPERIENCE_BOTTLE, ChatColor.YELLOW + "Save Rarity", Arrays.asList(ChatColor.GRAY + "Update the rarity of this", ChatColor.GRAY + "drop to " + ChatColor.GOLD + String.valueOf(rarity) + ChatColor.GRAY + "."));
	...
	public void onClick(MenuView view, ClickType clickType, int slot, ItemStack itemStack) {
		if(itemStack ==null || itemStack.getType().isAir() || itemStack.getType() == Material.GRAY_STAINED_GLASS_PANE) return;
